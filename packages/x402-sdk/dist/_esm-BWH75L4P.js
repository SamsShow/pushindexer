...
import {
  ...
  weiUnits,
  withResolvers
} from "./chunk-6IAYLXEH.js";
import {
  clean,
  createHasher,
  rotl
} from "./chunk-L7YTKAF3.js";
import {
  __export
...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-IXFCME6J.js");
  const signature_ = (() => {
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./_esm-CBA3Q6AV.js").then((module) => module.WebSocket);
...
function weierstrassPoints(opts) {
  ...
  class Point {
     ...
     */
    static fromHex(hex) {
      const P = Point.fromAffine(fromBytes5(ensureBytes("pointHex", hex)));
      P.assertValidity();
      return P;
    }
